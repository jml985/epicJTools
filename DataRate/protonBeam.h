...
// Mon Feb 26 10:00:56 2024 by ROOT version 6.30/02
// from TTree events/events data tree
// found on file: protonBeamGas.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("protonBeamGas.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("protonBeamGas.root");
      }
